...
#### 下载安装:
``` bash
wget -N --no-check-certificate https://raw.githubusercontent.com/atleast06/doubi/master/lightsocks.sh && chmod +x lightsocks.sh && bash lightsocks.sh
```
...
#### 下载安装:
``` bash
wget -N --no-check-certificate https://raw.githubusercontent.com/atleast06/doubi/master/daze.sh && chmod +x daze.sh && bash daze.sh
```
...
#### 下载安装:
``` bash
wget -N --no-check-certificate https://raw.githubusercontent.com/atleast06/doubi/master/mtproxy.sh && chmod +x mtproxy.sh && bash mtproxy.sh
```
...
#### 下载安装:
``` bash
wget -N --no-check-certificate https://raw.githubusercontent.com/atleast06/doubi/master/mtproxy_go.sh && chmod +x mtproxy_go.sh && bash mtproxy_go.sh
```
...
#### 下载安装:
``` bash
wget -N --no-check-certificate https://raw.githubusercontent.com/atleast06/doubi/master/iptables-pf.sh && chmod +x iptables-pf.sh && bash iptables-pf.sh
```
...
#### 下载安装:
``` bash
wget -N --no-check-certificate https://raw.githubusercontent.com/atleast06/doubi/master/brook-pf.sh && chmod +x brook-pf.sh && bash brook-pf.sh
```
...
#### 下载安装:
``` bash
wget -N --no-check-certificate https://raw.githubusercontent.com/atleast06/doubi/master/haproxy.sh && chmod +x haproxy.sh && bash haproxy.sh
```
...
#### 下载安装:
``` bash
wget -N --no-check-certificate https://raw.githubusercontent.com/atleast06/doubi/master/socat.sh && chmod +x socat.sh && bash socat.sh
```
...
#### 下载安装:
``` bash
wget -N --no-check-certificate https://raw.githubusercontent.com/atleast06/doubi/master/tinymapper.sh && chmod +x tinymapper.sh && bash tinymapper.sh
```
...
#### 下载安装:
``` bash
wget -N --no-check-certificate https://raw.githubusercontent.com/atleast06/doubi/master/aria2.sh && chmod +x aria2.sh && bash aria2.sh
```
...
#### 下载安装:
``` bash
wget -N --no-check-certificate https://raw.githubusercontent.com/atleast06/doubi/master/cloudt.sh && chmod +x cloudt.sh && bash cloudt.sh
```
...
#### 下载安装:
``` bash
wget -N --no-check-certificate https://raw.githubusercontent.com/atleast06/doubi/master/pserver.sh && chmod +x pserver.sh && bash pserver.sh
```
...
#### 下载安装:
``` bash
wget -N --no-check-certificate https://raw.githubusercontent.com/atleast06/doubi/master/bbr.sh && chmod +x bbr.sh && bash bbr.sh
```
...
#### 下载安装:
``` bash
wget -N --no-check-certificate https://raw.githubusercontent.com/atleast06/doubi/master/status.sh && chmod +x status.sh && bash status.sh
```
...
#### 下载安装:
``` bash
wget -N --no-check-certificate https://raw.githubusercontent.com/atleast06/doubi/master/ban_iptables.sh && chmod +x ban_iptables.sh && bash ban_iptables.sh
```
...
#### 下载安装:
``` bash
wget -N --no-check-certificate https://raw.githubusercontent.com/atleast06/doubi/master/ssh_port.sh && chmod +x ssh_port.sh && bash ssh_port.sh
```
...
#### 下载安装:
``` bash
wget -N --no-check-certificate https://raw.githubusercontent.com/atleast06/doubi/master/ocserv.sh && chmod +x ocserv.sh && bash ocserv.sh
```
...
#### 下载安装:
``` bash
wget -N --no-check-certificate https://raw.githubusercontent.com/atleast06/doubi/master/dowsdns.sh && chmod +x dowsdns.sh && bash dowsdns.sh
```
...
#### 下载安装:
``` bash
wget -N --no-check-certificate https://raw.githubusercontent.com/atleast06/doubi/master/caddy_install.sh && chmod +x caddy_install.sh && bash caddy_install.sh
 # 安装插件：
...
# 卸载命令：
wget -N --no-check-certificate https://raw.githubusercontent.com/atleast06/doubi/master/caddy_install.sh && chmod +x caddy_install.sh && caddy_install.sh uninstall
```
...
#### 下载安装:
``` bash
wget -N --no-check-certificate https://raw.githubusercontent.com/atleast06/doubi/master/pythonhttp.sh && chmod +x pythonhttp.sh && bash pythonhttp.sh
```
...
#### 下载安装:
``` bash
wget -N --no-check-certificate https://raw.githubusercontent.com/atleast06/doubi/master/adbyby.sh && chmod +x adbyby.sh && bash adbyby.sh
```
...
#### 下载安装:
``` bash
wget -N --no-check-certificate https://raw.githubusercontent.com/atleast06/doubi/master/gfw_push.sh && chmod +x gfw_push.sh && bash gfw_push.sh
```
...
#### 下载安装:
``` bash
wget -N --no-check-certificate https://raw.githubusercontent.com/atleast06/doubi/master/libsodium.sh && chmod +x libsodium.sh && bash libsodium.sh
```
...
#### 下载安装:
``` bash
wget -N --no-check-certificate https://raw.githubusercontent.com/atleast06/doubi/master/ssr_check.sh && chmod +x ssr_check.sh
```
...
#### 下载安装:
``` bash
wget -N --no-check-certificate https://raw.githubusercontent.com/atleast06/doubi/master/ssrstatus.sh && chmod +x ssrstatus.sh && bash ssrstatus
```
...
#### 下载安装:
``` bash
wget -N --no-check-certificate https://raw.githubusercontent.com/atleast06/doubi/master/ssr_ip_check.sh && chmod +x ssr_ip_check.sh
```
...
#### 下载安装:
``` bash
wget -N --no-check-certificate https://raw.githubusercontent.com/atleast06/doubi/master/gogo.sh && chmod +x gogo.sh && bash gogo.sh
```
